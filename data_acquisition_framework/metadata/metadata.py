...
class MediaMetadata:
    ...
    def create_metadata(self, media_info):
        metadata = {'raw_file_name': media_info['raw_file_name'],
                    ...
                    'speaker_name': self.config_json['speaker_name'] if self.config_json['speaker_name'] else
                    media_info['name'],
                    ...
                    'speaker_gender': str(self.config_json['speaker_gender']).lower() if self.config_json[
                        'speaker_gender'] else
                    media_info['gender'],
                    'source_website': media_info['source_website'] if 'source_website' in media_info else
                    self.config_json[
                        "source_website"],
